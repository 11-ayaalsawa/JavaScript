...
function doubleValues(arr){
  ...
  document.getElementById('task1').innerHTML=  doubleValues([1,2,3]) +" / "+doubleValues([5,1,2,3,10]);
...
function onlyEvenValues(arr){
  ...
  document.getElementById('task2').innerHTML=  onlyEvenValues([1,2,3]) +" / "+onlyEvenValues([5,1,2,3,10])
...
function showFirstAndLast(arr){
  ...
  document.getElementById('task3').innerHTML=showFirstAndLast(['colt','matt', 'tim', 'udemy'])+" / "+ showFirstAndLast(['hi', 'goodbye', 'smile'])  ;
